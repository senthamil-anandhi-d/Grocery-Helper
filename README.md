# 🛒 Grocery Helper | Smart Price Comparison & Billing

Grocery Helper is a premium, mobile-compatible web application designed to help shoppers make smarter financial decisions. It features a powerful real-time price comparison tool and a built-in bill calculator using INR (₹) currency.
...
The app is designed with a mobile-first approach, featuring large touch-friendly buttons and a responsive layout that adapts to any screen size.
...
---
© 2026 Grocery Helper. Created for smart shoppers.
